...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.addEventListener("load", function () {
    if (document.body.classList.contains("page-template-page-home")) {
      var flkty = new (flickity__WEBPACK_IMPORTED_MODULE_0___default())('.testimonials-carousel', {
        // options
        wrapAround: true,
        autoPlay: 4000,
...
$(function () {
  ...
  var megaMenu = document.querySelector('.main-menu-wrapper');
  var navHeight = 0; // Change this to match the actual height of your navigation bar

  function setElementHeight() {
    var height = window.innerHeight - navHeight;
    megaMenu.style.setProperty('--element-height', "".concat(height, "px"));
  }
  setElementHeight();
  window.addEventListener('resize', setElementHeight);

  /* Hamburguer menu toogle */
  var $toggleBtn = $('.main-menu-toggle');
  var togglerTl = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
    defaults: {
      duration: 0.7,
      ease: 'ease-in-out',
      autoAlpha: 0
  ...
  var $targets = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray('.main-menu-content .menu-item');
  togglerTl.from($targets, {
    x: '-50%',
    opacity: 0,
    stagger: 0.15
  });
...
/* harmony import */ var _flickity__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./flickity */ "./assets/js/flickity.js");
/* harmony import */ var _header_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./header-menu */ "./assets/js/header-menu.js");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkbrister"] = self["webpackChunkbrister"] || [];
