...
/* harmony import */ var _header_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./header-menu */ "./assets/js/header-menu.js");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.addEventListener("load", function () {
    if (document.body.classList.contains("page-template-page-home")) {
      var agendaEventsSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-agenda-events', {
        loop: true,
        //effect: 'flip',
        speed: 800,
        // Navigation arrows
