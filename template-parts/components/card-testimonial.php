<article id="post-<?php the_ID(); ?>" <?php post_class( 'carousel-cell card-testimonial flex flex-col p-6 lg:p-12 border-4 border-green rounded-tr-3xl rounded-br-3xl rounded-bl-3xl mx-4 md:mx-8 max-w-4xl' ); ?>>
	...
	<blockquote class="font-sans text-lg lg:text-xl leading-8 lg:leading-10 mb-11"><?php echo esc_html( wp_strip_all_tags( get_the_content() ) ); ?></blockquote>
