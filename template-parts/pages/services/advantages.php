<section class="section-advantages px-4 lg:px-8 py-20 lg:py-32 grid grid-cols-1 lg:grid-cols-12 relative">
	<div class="lg:col-span-6 lg:col-start-4 text-center">
		...
		if ( have_rows( 'advantages_list' ) ) :
			echo '<ul class="advantages-list w-full list lg:columns-2 lg:gap-8 text-start lg:ml-16">';
