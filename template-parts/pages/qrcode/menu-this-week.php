<?php
$menus_this_week = get_field( 'menus_this_week' );
if ( $menus_this_week ) :
	?>
	<section class="section-menu-this-week pt-20 md:pt-36 pb-24 md:pb-40 px-4 md:px-8 w-full">
		<div class="text-center md:px-8 max-w-full md:max-w-screen-md mx-auto">
			<h2 class="title-section text-green"><?php esc_html_e( 'This week', 'brister' ); ?></h2>
		...
		<div class="menus-grid w-full grid grid-cols-1 lg:grid-cols-12 gap-8">
			<?php
			foreach ( $menus_this_week as $post ) :
				setup_postdata( $post );
